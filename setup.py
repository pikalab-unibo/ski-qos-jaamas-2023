...
from knowledge import generate_census_income_knowledge, get_census_income_knowledge, get_splice_junction_knowledge, \
    get_poker_knowledge
...
class GenerateCensusKnowledge(distutils.cmd.Command):
    ...
    def run(self) -> None:
        generate_census_income_knowledge()
...
class RunExperiments(distutils.cmd.Command):
    ...
    def run(self) -> None:
        ...
        poker_knowledge = get_poker_knowledge()
...
setup(
    ...
    cmdclass={
        ...
        'generate_census_knowledge': GenerateCensusKnowledge,
